...
export function AddWorkExperienceModal({ token }: { token: string }) {
    ...
    const onsubmit = async (data: WorkExperienceFormValues) => {
        ...
        toast.loading("Adding Work Experience...", { id: toastId, duration: Infinity });
        ...
        try {
            ...
            if (!userResponse.ok || !userData.success) {
                toast.error(userData.message || "Failed to authenticate user data.", { id: toastId });
                return;
            }
            ...
            if (!apiResponse.ok || !apiResponseData.success) {
                ...
                toast.error(apiResponseData.message || "Adding work experience failed.", { id: toastId });
                return;
            }
            ...
            console.error(err);
            toast.error("Failed to add work experience. A network or server error occurred.", { id: toastId });
        }
    };
